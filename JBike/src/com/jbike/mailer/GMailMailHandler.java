...
public class GMailMailHandler {
	...
	private static String username = "webmaster.jbike@gmail.com";
	private static String password = "jyaa2015";

	public static void send(String recipientEmail, String title,
